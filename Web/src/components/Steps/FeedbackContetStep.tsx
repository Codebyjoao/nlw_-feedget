  ...
  return(
    <>
      ...
      <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
        <textarea
          className="min-w-[304px] w-full main-h[112px] text-sm placeholder-zinc-400 text-zinc-100 border-zinc-600 bg-transparent rounded-md focus:border-brand-500 focus:ring-brand-500 focus:ring-1 outline-none resize-none scroll first-line:bar scrollbar-thumb-zinc-700 scrollbar-track-transparent scrollbar-thin"
